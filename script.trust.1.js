...
game.addPeopleToCommunity(1, factory.TrustComplexPerson(0.5, 0.01, 0.05), groupBlue);
game.addPeopleToCommunity(1, factory.TrustComplexPerson(0.5, 0.01, 0.05), groupRed);